...
int main() {
	...
	vao3->AddVertexBuffer(interleaved2_vbo, {
		BufferAttribute(0, 3, GL_FLOAT, false, stride2, 0),
		BufferAttribute(1, 3, GL_FLOAT, false, stride2, sizeof(float) * 3),
		});
